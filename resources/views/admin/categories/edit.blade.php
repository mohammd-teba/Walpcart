                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Projects Categories </span>
                        </div>
                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$key}}]" id="title"
                                                                   value="{{$category->translation($key)->title}}"
                                                                   class="form-control"
...
{{--                                                {{ dd($category->translation($key)->description) }}--}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                                <textarea type="text" name="description[{{$key}}]"
                                                                          ...
                                                                          class="ckeditor"
                                                                          rows="5"
                                                                          placeholder="Add description ({{$lang}})...">{{$category->translation($key)->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
