                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{url(admin_managerMessages_url().'/managerMessage-create')}}" class="btn sbold green"><i
...
@section('js')
    ...
    <script src="{{url(assets('admin'))}}/js/managerMessages.js" type="text/javascript"></script>
