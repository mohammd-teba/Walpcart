                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Manager Messages </span>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new"
                                                    ...
                                                    <div class="fileinput-preview thumbnail"
                                                        ...
                                                        <img
                                                            src="{{$managerMessage->image ?? url('assets/apps/img/unknown.png')}}"
                                                            alt=""/>
                                    ...
                                    @foreach(config('languages.name') as $key => $lang)
                                        ...
                                        <div class="tab-pane fade @if($loop->first) active in @endif "
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="name[{{$key}}]" id="name"
                                                                   value="{{$managerMessage->translation($key)->name}}"
                                                                   class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$key}}]" id="title"
                                                                   value="{{$managerMessage->translation($key)->title}}"
                                                                   class="form-control"
                                                                   placeholder="Add title ({{$lang}})...">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="job_title[{{$key}}]" id="job_title"
                                                                   value="{{$managerMessage->translation($key)->job_title}}"
                                                                   class="form-control"
                                                                   placeholder="Add title ({{$lang}})...">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Job_description ({{$lang}}
                                                            ):</label>
                                                        <div class="col-md-9">
                                                                <textarea type="text" name="job_description[{{$key}}]"
                                                                          id="description"
                                                                          class="form-control"
                                                                          rows="5"
                                                                          placeholder="Add description ({{$lang}})...">{{$managerMessage->translation($key)->job_description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                                <textarea type="text" name="description[{{$key}}]"
                                                                          ...
                                                                          class="ckeditor"
                                                                          rows="5"
                                                                          placeholder="Add description ({{$lang}})...">{{$managerMessage->translation($key)->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
